...
<div style={{ backgroundColor: '#EAF2FB', border: '1px solid #D6E4F5', padding: '0.4rem 1.25rem', margin: '0 0 1.5rem 0', color: '#1F2D3D' }}>[`interaction_kernel/`](https://github.com/doesburg11/EvolvedCooperation/tree/main/moran_models/interaction_kernel) replaces the earlier feedback-kernel design note with a concrete implementation that routes positive and negative effects through explicit kernels before selection.</div>
