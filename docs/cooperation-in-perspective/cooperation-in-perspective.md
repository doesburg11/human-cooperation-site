...
<figure style={{ margin: '0 0 2rem', textAlign: 'center' }}>
  <div style={{ width: '100%', maxWidth: '1180px', margin: '0 auto', overflow: 'hidden' }}>
    <div className="blue-banner">
      <div className="blue-banner-title">Low-Road and High-Road Pathways to a Response</div>
      <div className="blue-banner-subtitle">The low and high roads differ in speed and how much evaluation intervenes before a response; simple spinal reflexes are a separate system.</div>
    </div>
    <img src="/img/cooperation-in-perspective/display-fast-slow-paths.svg" alt="Display 8: Flowchart from social stimulus through the thalamus, branching into a low road directly to the amygdala producing a fast trust judgment, and a high road through sensory cortex producing a more deliberate evaluation before also reaching the amygdala, converging on motor systems and a cooperative or defective response. A separate, disconnected note explains that simple spinal reflexes bypass the brain entirely and never reach the thalamus." style={{ display: 'block', width: '100%', height: 'auto' }} />
  </div>
